...
#define INPUT_RIGHT_Pin GPIO_PIN_11
#define INPUT_RIGHT_GPIO_Port GPIOA
#define INPUT_DOWN_Pin GPIO_PIN_12
#define INPUT_DOWN_GPIO_Port GPIOA
#define INPUT_LEFT_Pin GPIO_PIN_15
#define INPUT_LEFT_GPIO_Port GPIOA
