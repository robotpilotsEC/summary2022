...
gimbal_motor_pid_t 	gimb_motor_pid[GIMBAL_MOTOR_CNT] = {
	[GIMB_PITCH_CLASS] = {
		.speed.kp = 6.f, //6    //12  12  20  16  7
		.speed.ki = 0.7f, //0.2 0.1 0.7   1  0.7  0.7
		.speed.kd = 0.f,
		.speed.integral_max = 26000.f,
		.speed.out_max = 28000.f,
		.angle.kp = 15.f, //20  //20           20
		.angle.ki = 0.f,
		.angle.kd = 0.f,
	...
	[GIMB_YAW_CLASS] = {
		.speed.kp = 12.f,  //12    16   12
		.speed.ki = 0.5f,  //0.5    0.8  0.5
		.speed.kd = 0.f,
...
void GIMBAL_UpdateController(void)
{
	...
	//卡尔曼
	gimb_motor_pid[GIMB_PITCH_CLASS].speed.measure = KalmanFilter(&pitch_measure_rateKF ,-imu_sensor.info->rate_pitch);
