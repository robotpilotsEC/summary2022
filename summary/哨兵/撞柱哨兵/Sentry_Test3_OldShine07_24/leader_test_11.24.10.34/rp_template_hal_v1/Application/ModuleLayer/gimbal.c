...
gimbal_motor_pid_t 	gimb_motor_pid[GIMBAL_MOTOR_CNT] = {
	[GIMB_PITCH_CLASS] = {
		.speed.kp = 10.f,     //6    7    7   7   12   15
		.speed.ki = 0.6f,   // 0.1  0.7  0.3 0.7   0.8  1
		.speed.kd = 0.f,
...
//	gimb_motor_pid[GIMB_YAW_CLASS].speed.measure = -imu_sensor.info->rate_yaw;
	...
	//卡尔曼
	gimb_motor_pid[GIMB_PITCH_CLASS].speed.measure = KalmanFilter(&gimbal_pitch_rateKF, imu_sensor.info->rate_pitch);
	gimb_motor_pid[GIMB_YAW_CLASS].speed.measure = KalmanFilter(&gimbal_yaw_rateKF, -real_yaw_rate);
//  //电机速度
