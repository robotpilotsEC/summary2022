...
/* Definitions for cap_loop */
osThreadId_t cap_loopHandle;
const osThreadAttr_t cap_loop_attributes = {
  .name = "cap_loop",
  .stack_size = 512 * 4,
...
void MX_FREERTOS_Init(void) {
  ...
  /* creation of cap_loop */
  cap_loopHandle = osThreadNew(Startcap_loop, NULL, &cap_loop_attributes);
...
__weak void Startcap_loop(void *argument)
{
