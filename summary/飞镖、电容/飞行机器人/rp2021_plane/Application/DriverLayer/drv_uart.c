...
void USART_TxByte(drv_uart_t *drv, uint8_t txByte)
{
    ...
    {
        case DRV_UART1:
            HAL_UART_Transmit(&huart1, &txByte, 1, 0xffff);
            break;
        
        case DRV_UART2:
            HAL_UART_Transmit(&huart2, &txByte, 1, 0xffff);
            break;
        
        case DRV_UART3:
            HAL_UART_Transmit(&huart3, &txByte, 1, 0xffff);
            break;
        
        case DRV_UART4:
            HAL_UART_Transmit(&huart4, &txByte, 1, 0xffff);
            break;
        
        case DRV_UART5:
            HAL_UART_Transmit(&huart5, &txByte, 1, 0xffff);
            break;
...
void USART_TxBuff(drv_uart_t *drv, uint8_t *txBuff, uint16_t txSize)
{
    ...
    {
        case DRV_UART1:
            HAL_UART_Transmit(&huart1, txBuff, txSize, 0xffff);
            break;
        
        case DRV_UART2:
            HAL_UART_Transmit(&huart2, txBuff, txSize, 0xffff);
            break;
        
        case DRV_UART3:
            HAL_UART_Transmit(&huart3, txBuff, txSize, 0xffff);
            break;
        
        case DRV_UART4:
            HAL_UART_Transmit(&huart4, txBuff, txSize, 0xffff);
            break;
        
        case DRV_UART5:
            HAL_UART_Transmit(&huart5, txBuff, txSize, 0xffff);
            break;
...
void USART_TxBuff_DMA(drv_uart_t *drv, uint8_t *txBuff, uint16_t txSize)
{
    ...
    {
        case DRV_UART1:
            HAL_UART_Transmit_DMA(&huart1, txBuff, txSize);
            break;
        
        case DRV_UART2:
            HAL_UART_Transmit_DMA(&huart2, txBuff, txSize);
            break;
        
        case DRV_UART3:
            HAL_UART_Transmit_DMA(&huart3, txBuff, txSize);
            break;
        
        case DRV_UART4:
            HAL_UART_Transmit_DMA(&huart4, txBuff, txSize);
            break;
        
        case DRV_UART5:
            HAL_UART_Transmit_DMA(&huart5, txBuff, txSize);
            break;
